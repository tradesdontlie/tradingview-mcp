# Baby Biker Codex Pet Design

## Goal

Create a Codex-compatible v2 animated pet inspired by the baby in the four supplied photographs. The pet is a friendly chibi biker who remains seated on a compact gray three-wheel motorcycle in every animation.
...
The baby stays seated and connected to the vehicle throughout all standard Codex pet states. Motion is expressed through wheel rotation, suspension bounce, handlebar and body lean, head movement, hand gestures, facial expression, and small speed or review effects.

- Idle: gentle engine vibration and blink.
- Running right/left: motorcycle travels laterally with spinning wheels and a mild rider lean.
- Waving: one hand waves while the other remains on the handlebar.
- Jumping: the three-wheeler performs a small, safe hop as one unit.
- Failed: engine sputter, rider looks disappointed, vehicle remains upright.
