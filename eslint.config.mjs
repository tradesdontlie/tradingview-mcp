...
// `no-undef` flags those statically, so a lint pass blocks the regression.
//
// This fork keeps hitting this class (the active branch is literally named after
// one; the getVisibleRange/symbolInfo DI miss was another). (Ported from
// upstream 98c4ee1 / PR #205.)
//
